...
@Schema(description = "Recorte de página da listagem de eventos observados")
public record ListObservedEventsQueryDTO(
    ...
    @Min(value = 1, message = "Tamanho de página deve estar entre 1 e 100")
        ...
        @Schema(description = "Quantidade de eventos por página", defaultValue = "20", example = "20")
        Integer size) {

  private static final int DEFAULT_PAGE = 0;
  private static final int DEFAULT_SIZE = 20;

  public ListObservedEventsUseCase.Input toInput(String applicationId) {
    return new ListObservedEventsUseCase.Input(
