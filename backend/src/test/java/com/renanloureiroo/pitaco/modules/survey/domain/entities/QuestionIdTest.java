...
class QuestionIdTest {
  ...
  void gera_um_uuid_valido() {
    var generated = QuestionId.generate();
  ...
  void o_identificador_gerado_volta_pelo_of() {
    ...
    assertThat(QuestionId.of(generated.value())).isEqualTo(generated);
  }
  ...
  void aceita_um_uuid() {
    ...
    assertThat(QuestionId.of(value).value()).isEqualTo(value);
  }
