 ...
 *
 * <p>
 * Diferente do {@link Slug}, é rótulo de painel: aceita qualquer texto legível
 * e muda livremente. Espaço em volta é ruído de digitação e some na construção,
 * de modo que dois nomes que só diferem nisso são o mesmo nome.
 */
