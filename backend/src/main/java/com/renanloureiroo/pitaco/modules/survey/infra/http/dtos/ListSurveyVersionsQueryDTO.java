...
@Schema(description = "Recorte de página da listagem de versões publicadas")
public record ListSurveyVersionsQueryDTO(
  ...
  public ListSurveyVersionsUseCase.Input toInput(String applicationId, String surveyId) {
    return new ListSurveyVersionsUseCase.Input(
        applicationId,
        surveyId,
