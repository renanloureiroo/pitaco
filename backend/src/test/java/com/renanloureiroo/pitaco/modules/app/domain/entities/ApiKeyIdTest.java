...
class ApiKeyIdTest {
  ...
  void aceita_um_uuid() {
    ...
    assertThat(ApiKeyId.of(value).value()).isEqualTo(value);
  }

  @Test
  void o_identificador_gerado_volta_pelo_of() {
    var generated = ApiKeyId.generate();

    assertThat(ApiKeyId.of(generated.value())).isEqualTo(generated);
  }
