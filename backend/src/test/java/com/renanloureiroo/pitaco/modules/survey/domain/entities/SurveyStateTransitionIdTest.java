...
@DisplayName("SurveyStateTransitionId")
class SurveyStateTransitionIdTest {

  @Test
  void gera_um_uuid_valido() {
    var generated = SurveyStateTransitionId.generate();
  ...
  void o_identificador_gerado_volta_pelo_of() {
    ...
    assertThat(SurveyStateTransitionId.of(generated.value())).isEqualTo(generated);
  }
  ...
  void aceita_um_uuid() {
    ...
    assertThat(SurveyStateTransitionId.of(value).value()).isEqualTo(value);
  }
  ...
  void rejeita_identificador_fora_do_formato_uuid(String invalid) {
    assertThatThrownBy(() -> SurveyStateTransitionId.of(invalid))
        .isInstanceOf(DomainException.class)
        .satisfies(
            error -> {
              var domainError = (DomainException) error;
              assertThat(domainError.type()).isEqualTo(ErrorType.VALIDATION);
              assertThat(domainError.code()).isEqualTo("survey_state_transition.id_invalid");
            });
  }
