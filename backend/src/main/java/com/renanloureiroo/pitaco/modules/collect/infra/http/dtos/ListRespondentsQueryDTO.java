...
@Schema(description = "Recorte de página da listagem de respondentes")
public record ListRespondentsQueryDTO(
  ...
  public ListRespondentsUseCase.Input toInput(String applicationId) {
    return new ListRespondentsUseCase.Input(
