...
@Schema(description = "Recorte de página da listagem de atributos observados")
public record ListObservedAttributesQueryDTO(
  ...
  public ListObservedAttributesUseCase.Input toInput(String applicationId) {
    return new ListObservedAttributesUseCase.Input(
